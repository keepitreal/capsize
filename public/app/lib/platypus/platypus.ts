/* 
 * PlatypusTS v0.0.1.5 (http://getplatypi.com)
        ...
        export class Browser implements IBrowser {
            ...
            url(url?: string, replace?: boolean) {
                ...
                if (isString(url) && this.__lastUrl !== url) {
                    this.__lastUrl = url;
                    return this._setUrl(url, replace);
                } else {
        ...
        export module controls {
            ...
            export class Template extends TemplateControl {
                ...
                private __mapBindableTemplates(control: Template) {
                    (<ui.BindableTemplates>this.bindableTemplates)._cache =
                        (<ui.BindableTemplates>control.bindableTemplates)._cache;
